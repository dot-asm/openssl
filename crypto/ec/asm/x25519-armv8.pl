# Base 2^64 implementation vs. gcc 5.4
#
#		2^51		2^25.5
#
# Apple-A7	+15%		+120%		230k
# Cortex-A53	+11%		+23%		470k
# Cortex-A57	+16%		-0%		360k
# X-Gene	+7%		+59%		315k
# Denver	+9%		+50%		210k
# Mongoose	+19%				240k
...
$code.=<<___;
	...
	add	$t0,$acc4,$acc4,lsl#3
	add	$t0,$acc4,$t0,lsl#1

	adds	$acc0,$acc0,$t0,lsl#1
	adcs	$acc1,$acc1,xzr
	adcs	$acc2,$acc2,xzr
	adcs	$acc3,$acc3,xzr
	adc	$acc4,xzr,xzr
